...
async def create_super_admin_role():
    role = await Role.create(label='Super Admin', remark='Super Admin')
    return role
...
async def main(username: str, phone: str, email: str, password: str):
    async with ctx():
...
if __name__ == '__main__':
    ...
    parser.add_argument('--phone', type=str, default='13800138000', help='Phone number for super admin (default: 13800138000)')
    parser.add_argument('--email', type=str, default='admin@example.com', help='Email for super admin (default: admin@example.com)')
    parser.add_argument('--password', type=str, default='password', help='Password for super admin (default: password)')
